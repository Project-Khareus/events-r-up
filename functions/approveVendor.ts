        ...
        if (emailToSend) {
            await base44.integrations.Core.SendEmail({
                ...
                body: `
                    ...
                    <br/>
                    <a href="https://${req.headers.get("host")}/ManageListing" style="background-color: #4F46E5; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Manage Listing</a>
                `
            });
        }
