...
export default function AdPlaceholderCard() {
  return (
    <div className="relative overflow-hidden rounded-2xl border-2 border-dashed border-slate-200 bg-gradient-to-br from-slate-50 to-indigo-50/50 h-full min-h-[280px] flex flex-col items-center justify-center p-6 text-center group hover:border-indigo-300 hover:bg-indigo-50/30 transition-all cursor-pointer">
