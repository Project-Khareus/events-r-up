    ...
    <div className="min-h-screen bg-slate-50 flex flex-col" style={{ paddingTop: 'env(safe-area-inset-top)', paddingBottom: 'env(safe-area-inset-bottom)' }}>
      <style>{`
                    ...
                    */
                    ...
                    .dark [class*="hover:bg-slate-100"]:hover { background-color: #334155 !important; }
                    .dark [class*="hover:bg-slate-200"]:hover { background-color: #3d5068 !important; }
                    .dark [class*="hover:bg-white"]:hover { background-color: var(--color-surface-elevated) !important; }
                    .dark [class*="hover:bg-gray-50"]:hover { background-color: #1e293b !important; }
                    .dark [class*="hover:bg-gray-100"]:hover { background-color: #334155 !important; }
                    .dark [class*="hover:bg-gray-200"]:hover { background-color: #3d5068 !important; }
                    ...
                    @media (prefers-color-scheme: dark) {
                      ...
                      :root:not(.light-mode) [class*="hover:bg-slate-100"]:hover { background-color: #334155 !important; }
                      :root:not(.light-mode) [class*="hover:bg-white"]:hover { background-color: var(--color-surface-elevated) !important; }
                      :root:not(.light-mode) [class*="hover:bg-gray-50"]:hover { background-color: #1e293b !important; }
                      :root:not(.light-mode) [class*="hover:bg-gray-100"]:hover { background-color: #334155 !important; }
